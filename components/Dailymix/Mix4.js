...
var playlist=[]
export default class Mix4 extends Component {
    ...
    constructor(props){
      ...
      componentDidMount(){
        axios.get("https://music-application-ftd.000webhostapp.com/DailyMix/day4.php")
            .then(response => {
                    this.setState({
    ...
    <ScrollView style={{backgroundColor:this.state.bdcolor,flex:1}}
        refreshControl={<RefreshControl refreshing={this.state.refreshing} onRefresh={this._onRefresh}/>}>
               ...
               <Image style={{height: 250,width: '100%',borderBottomLeftRadius: 50,borderBottomRightRadius: 50}}
                  source={{
                  uri:
                      "https://firebasestorage.googleapis.com/v0/b/ftd-play-music.appspot.com/o/6.png?alt=media&token=d24b97ee-df61-4ae6-81e9-915ddb9b8e7b",
                  }}
                  resizeMode="stretch" />
