...
var playlist=[]
export default class Mix2 extends Component {
    ...
    constructor(props){
      ...
      componentDidMount(){
        axios.get("https://music-application-ftd.000webhostapp.com/DailyMix/day2.php")
            .then(response => {
                    this.setState({
      ...
      <ScrollView style={{backgroundColor:this.state.bdcolor,flex:1}}
           refreshControl={<RefreshControl refreshing={this.state.refreshing} onRefresh={this._onRefresh}/>}>
             ...
             <Image style={{height: 250,width: '100%',borderBottomLeftRadius: 50,borderBottomRightRadius: 50}}
                  source={{
                  uri:
                      "https://firebasestorage.googleapis.com/v0/b/ftd-play-music.appspot.com/o/4.png?alt=media&token=13181c6e-5fff-41dd-adcf-727ae09d74e6",
                  }}
                  resizeMode="stretch" />
